...
urlpatterns = [
    ...
    path("doctor_profile/<int:doctor_id>/", doctor_profile_view, name="doctor_profile"),
    ...
    path('doctor_profile/<int:doctor_id>/', views.doctor_profile_view, name='doctor_profile'),  # Handles a specific doctor's profile
    ...
    path('patient_profile/<int:patient_id>/', views.patient_profile_view, name='patient_profile'),
    path('patient/edit/<int:id>/', edit_patient_profile, name='edit_patient_profile'),
    path('patient_profile/', views.patient_profile_view, name='patient_profile'),
